...
| 特殊日 | 时段A | 时段B | 邮件窗口 | 时段C | 总可用 | 变化 |
|--------|-------|-------|----------|-------|--------|------|
| Sprint Plan周一 | 2h | 1.5h | 0.5h | 1.5h | 5.5h | -0.5h |
| Sprint Review周四 | 2h | 1.5h | 0.5h | 1h | 5h | -1h |
| 月度分享周三 | 2h | ❌被覆盖 | ❌被覆盖 | 2.5h | 4.5h | -1.5h |
| 正常日 | 2h | 1.5h | 0.5h | 2.5h | 6h | 基准 |
...
**Total available focus time: ~6 hours/day**
**邮件窗口**: 14:30-15:00 (30min) — 集中处理邮件和消息，避免碎片化打断
